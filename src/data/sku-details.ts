  ...
  cn215w: {
    ...
    features: [
      ...
      },
      {
        ...
        body: 'Backed by a 12-year product quality warranty and a 25-year linear power warranty (84.5% output at year 25; 1% first-year + 0.4%/year linear), ensuring long-term reliability and secure energy returns.',
      },
    ],
    tech: {
      electrical: [
        ...
        { label: 'VMP / IMP',               value: '17.3 V / 12.38 A' },
      ...
      thermal: [
        { label: 'CIRCUIT DESIGN',          value: 'Quad-cell anti-shading layout' },
        ...
        { label: 'PRODUCT WARRANTY',        value: '12 years product · 25 years linear power' },
      ],
    },
    certifications: [
      'IEC 61215 · IEC 61730',
  ...
  cn210w: {
    ...
    tech: {
      electrical: [
        ...
        { label: 'SYSTEM CONFIGURATION',    value: 'Suitable for 24V systems' },
        { label: 'STANDARD TEST CONDITIONS', value: '1000 W/m² · 25°C · AM1.5' },
      ],
      mechanical: [
        { label: 'CELL TYPE',         value: 'N-Type · 16BB · 182 mm mono' },
        { label: 'DIMENSIONS',        value: '1377 × 767 × 36 mm' },
        { label: 'WEIGHT',            value: '11.3 kg' },
        { label: 'GLASS',             value: '3.2 mm tempered glass' },
        { label: 'IP RATING',         value: 'IP68' },
        { label: 'WIND / SNOW LOAD',  value: '2400Pa / 5400Pa' },
        { label: 'MOUNTING',          value: '12 mounting holes' },
      ],
      thermal: [
        { label: 'CIRCUIT DESIGN',          value: 'Dual-module parallel circuitry' },
        { label: 'CELL LAYOUT',             value: '1/4-cut cell' },
        { label: 'TEMPERATURE COEFFICIENT', value: '-0.30%/K' },
        { label: 'BIFACIAL ENERGY GAIN',    value: '7%~30%*' },
        { label: '25-YEAR OUTPUT',          value: '84.5%' },
        { label: 'CONNECTOR',               value: 'Solar connector' },
