...
export const PRODUCTS: ProductSpec[] = [
  {
    ...
    images: {
      hero: '/uploads/callsun/products/450w/hero-01.jpg',
      card: '/uploads/callsun/products/450w/hero-01.jpg',
      frontBack: '/uploads/callsun/products/450w/01-front.jpg',
    },
  ...
  },
  {
    ...
    images: {
      hero: '/uploads/callsun/products/580w/hero-01.jpg',
      card: '/uploads/callsun/products/580w/card-square.jpg',
      frontBack: '/uploads/callsun/products/580w/front-back.jpg',
    },
  ...
  },
  {
    ...
    images: {
      hero: '/uploads/callsun/products/620w/hero-01.jpg',
      card: '/uploads/callsun/products/620w/card-square.jpg',
      frontBack: '/uploads/callsun/products/620w/front-back.jpg',
    },
  ...
  },
  {
    ...
    images: {
      hero: '/uploads/callsun/products/720w/hero-01.jpg',
      card: '/uploads/callsun/products/720w/card-square.jpg',
      frontBack: '/uploads/callsun/products/720w/front-back.jpg',
    },
  ...
  },
  {
    ...
    images: {
      hero: '/uploads/callsun/products/180w/hero-01.jpg',
      card: '/uploads/callsun/products/180w/hero-01.jpg',
      frontBack: '/uploads/callsun/products/180w/front-back.jpg',
    },
  },
  {
    slug: 'cn200w',
    ...
    images: {
      hero: '/uploads/callsun/products/200w/hero-01.jpg',
      card: '/uploads/callsun/products/200w/front.jpg',
      frontBack: '/uploads/callsun/products/200w/front-back.jpg',
    },
  },
  {
    slug: 'cn215w',
    ...
    images: {
      hero: '/uploads/callsun/products/215w/hero-01.jpg',
      card: '/uploads/callsun/products/215w/front.jpg',
      frontBack: '/uploads/callsun/products/215w/front-back.jpg',
    },
