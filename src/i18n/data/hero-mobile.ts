...
export const HERO_MOBILE: Record<'en' | 'de' | 'es' | 'ru', HeroMobileSlide[]> = {
  en: [
    ...
    { kicker: 'Standard PV Module', title: '215W Anti-Shading Module', sub: 'Engineered for real-world conditions', pill: '215W Maximum Power', align: 'left', pos: 'bottom', scrim: true },
    { kicker: 'Standard PV Module', title: '450W Power, Built for Space-Efficient Solar', pill: '450W Max Power', align: 'right', pos: 'top' },
    { kicker: 'Standard PV Module', title: '580W High-Power Module for Scalable Projects', pill: 'High Power', align: 'right', pos: 'top' },
  ...
  de: [
    ...
    { kicker: 'Standard-PV-Modul', title: '215W Anti-Shading-Modul', sub: 'Entwickelt für reale Bedingungen', pill: '215W Max. Leistung', align: 'left', pos: 'bottom', scrim: true },
    { kicker: 'Standard-PV-Modul', title: '450W Power für maximale Raumeffizienz', pill: '450W Max. Leistung', align: 'right', pos: 'top' },
    { kicker: 'Standard-PV-Modul', title: '580W Hochleistungs-Modul für skalierbare Projekte', pill: 'High Power', align: 'right', pos: 'top' },
  ...
  es: [
    ...
    { kicker: 'Módulo PV estándar', title: 'Módulo antisombras de 215W', sub: 'Diseñado para condiciones reales', pill: '215W Potencia máx.', align: 'left', pos: 'bottom', scrim: true },
    { kicker: 'Módulo PV estándar', title: '450W de potencia para energía solar eficiente en espacio', pill: '450W Potencia máx.', align: 'right', pos: 'top' },
    { kicker: 'Módulo PV estándar', title: 'Módulo de alta potencia 580W para proyectos escalables', pill: 'Alta potencia', align: 'right', pos: 'top' },
  ...
  ru: [
    ...
    { kicker: 'Стандартный PV-модуль', title: 'Модуль 215 Вт с защитой от затенения', sub: 'Создан для реальных условий', pill: '215 Вт макс. мощность', align: 'left', pos: 'bottom', scrim: true },
    { kicker: 'Стандартный PV-модуль', title: 'Мощность 450 Вт для экономии пространства', pill: '450 Вт макс. мощность', align: 'right', pos: 'top' },
    { kicker: 'Стандартный PV-модуль', title: 'Высокомощный модуль 580 Вт для масштабируемых проектов', pill: 'Высокая мощность', align: 'right', pos: 'top' },
